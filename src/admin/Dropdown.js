...
function Dropdown({Icon, badge, customToggle, contentData, renderItems, renderFooter, logOut}) {
                            ...
                            if(item.content === 'Logout'){
                                return (
                                    <div className="cursor-default" key={index}>
                                        <div onClick={logOut} className="flex space-x-2 p-5 text-gray-600 hover:bg-gray-200">
                                            {item.icon}
