function StatusCard({Icon, count, title, redirect}) {
    return (
        <div onClick={redirect} className="p-7 border flex items-center bg-white shadow-md rounded-md relative overflow-hidden z-10 transition duration-200 ease-out cursor-pointer group
