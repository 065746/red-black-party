...
function FourGirlsGroup() {
    ...
    const confirmUser = async () => {
        await updateDoc(doc(db, '4 Boys', id), { 
           status: 'Confirmed',
        }).then(() => setConfirm(true))
   }
   useEffect(() => {
       const getConfirm = async () => {
           const docRef =  doc(db, '4 Boys', id);
        ...
        <div className='w-[calc(100%-300px)] px-10 py-7 ml-auto'>
            {group?.map((row, index) => (
                <div key={index} className="space-y-8">
                    <div className="">
                        <h3 className="text-xl font-semibold">First Boy</h3>
                        <div className="px-2">
                    ...
                    <div className="">
                        <h3 className="text-xl font-semibold">Second Boy</h3>
                        <div className="px-2">
                    ...
                    <div className="">
                        <h3 className="text-xl font-semibold">Third Boy</h3>
                        <div className="px-2">
                    ...
                    <div className="">
                        <h3 className="text-xl font-semibold">Fourth Boy</h3>
                        <div className="px-2">
