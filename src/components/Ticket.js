function Ticket({price, info, type, setHideForm}) {
    return (
        <div className="text-white flex flex-col items-center transform px-4 pt-4 hover:scale-105 transition-all duration-300 shadow-md bg-gray-800 max-w-[250px] ml-3 mb-3 xl:m-0 border-4 border-gray-900">
            ...
            <button onClick={() => setHideForm(e => !e)} className="bg-purple-900 px-8 py-2 text-white my-4 border-2 border-gray-900 hover:bg-purple-700">Order Now</button>
        </div>
    )
}
